...
void setup(){
  ...
  Serial.println("Anntall requests sendt til Circus of Things siden ESP ble skrudd på: " + String(req_CoT_num));
  Serial.println("Anntall ganger ESP har bootet: " + String(boot_num));
  //go back to sleep
